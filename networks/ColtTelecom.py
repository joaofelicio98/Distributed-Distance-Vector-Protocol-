...
net.addLink("s1", "s2")
net.setDelay("s1", "s2", 27)
net.setBw("s1", "s2", 1)
net.addLink("s1", "s11")
net.setDelay("s1", "s11", 65)
net.setBw("s1", "s11", 1)
net.addLink("s1", "s100")
net.setDelay("s1", "s100", 74)
net.setBw("s1", "s100", 1)
net.addLink("s1", "s100")
net.setDelay("s1", "s100", 41)
net.setBw("s1", "s100", 1)
net.addLink("s3", "s145")
net.setDelay("s3", "s145", 74)
net.setBw("s3", "s145", 1)
net.addLink("s3", "s52")
net.setDelay("s3", "s52", 33)
net.setBw("s3", "s52", 1)
net.addLink("s4", "s145")
net.setDelay("s4", "s145", 58)
net.setBw("s4", "s145", 1)
net.addLink("s4", "s145")
net.setDelay("s4", "s145", 29)
net.setBw("s4", "s145", 1)
net.addLink("s5", "s9")
net.setDelay("s5", "s9", 52)
net.setBw("s5", "s9", 1)
net.addLink("s5", "s6")
net.setDelay("s5", "s6", 61)
net.setBw("s5", "s6", 1)
net.addLink("s6", "s145")
net.setDelay("s6", "s145", 60)
net.setBw("s6", "s145", 1)
net.addLink("s6", "s12")
net.setDelay("s6", "s12", 72)
net.setBw("s6", "s12", 1)
net.addLink("s7", "s12")
net.setDelay("s7", "s12", 65)
net.setBw("s7", "s12", 1)
net.addLink("s7", "s8")
net.setDelay("s7", "s8", 59)
net.setBw("s7", "s8", 1)
net.addLink("s8", "s145")
net.setDelay("s8", "s145", 36)
net.setBw("s8", "s145", 1)
net.addLink("s9", "s14")
net.setDelay("s9", "s14", 66)
net.setBw("s9", "s14", 1)
net.addLink("s10", "s14")
net.setDelay("s10", "s14", 26)
net.setBw("s10", "s14", 1)
net.addLink("s10", "s14")
net.setDelay("s10", "s14", 64)
net.setBw("s10", "s14", 1)
net.addLink("s11", "s98")
net.setDelay("s11", "s98", 67)
net.setBw("s11", "s98", 1)
net.addLink("s11", "s98")
net.setDelay("s11", "s98", 67)
net.setBw("s11", "s98", 1)
net.addLink("s11", "s99")
net.setDelay("s11", "s99", 64)
net.setBw("s11", "s99", 1)
net.addLink("s11", "s99")
net.setDelay("s11", "s99", 41)
net.setBw("s11", "s99", 1)
net.addLink("s11", "s102")
net.setDelay("s11", "s102", 62)
net.setBw("s11", "s102", 1)
net.addLink("s11", "s12")
net.setDelay("s11", "s12", 72)
net.setBw("s11", "s12", 1)
net.addLink("s11", "s14")
net.setDelay("s11", "s14", 43)
net.setBw("s11", "s14", 1)
net.addLink("s13", "s142")
net.setDelay("s13", "s142", 28)
net.setBw("s13", "s142", 1)
net.addLink("s13", "s31")
net.setDelay("s13", "s31", 59)
net.setBw("s13", "s31", 1)
net.addLink("s14", "s120")
net.setDelay("s14", "s120", 33)
net.setBw("s14", "s120", 1)
net.addLink("s15", "s18")
net.setDelay("s15", "s18", 38)
net.setBw("s15", "s18", 1)
net.addLink("s15", "s142")
net.setDelay("s15", "s142", 39)
net.setBw("s15", "s142", 1)
net.addLink("s16", "s19")
net.setDelay("s16", "s19", 37)
net.setBw("s16", "s19", 1)
net.addLink("s16", "s20")
net.setDelay("s16", "s20", 74)
net.setBw("s16", "s20", 1)
net.addLink("s16", "s133")
net.setDelay("s16", "s133", 45)
net.setBw("s16", "s133", 1)
net.addLink("s17", "s52")
net.setDelay("s17", "s52", 25)
net.setBw("s17", "s52", 1)
net.addLink("s17", "s61")
net.setDelay("s17", "s61", 48)
net.setBw("s17", "s61", 1)
net.addLink("s18", "s137")
net.setDelay("s18", "s137", 50)
net.setBw("s18", "s137", 1)
net.addLink("s18", "s135")
net.setDelay("s18", "s135", 55)
net.setBw("s18", "s135", 1)
net.addLink("s18", "s134")
net.setDelay("s18", "s134", 64)
net.setBw("s18", "s134", 1)
net.addLink("s18", "s134")
net.setDelay("s18", "s134", 43)
net.setBw("s18", "s134", 1)
net.addLink("s18", "s144")
net.setDelay("s18", "s144", 28)
net.setBw("s18", "s144", 1)
net.addLink("s19", "s143")
net.setDelay("s19", "s143", 37)
net.setBw("s19", "s143", 1)
net.addLink("s20", "s50")
net.setDelay("s20", "s50", 73)
net.setBw("s20", "s50", 1)
net.addLink("s21", "s24")
net.setDelay("s21", "s24", 70)
net.setBw("s21", "s24", 1)
net.addLink("s22", "s82")
net.setDelay("s22", "s82", 59)
net.setBw("s22", "s82", 1)
net.addLink("s23", "s24")
net.setDelay("s23", "s24", 56)
net.setBw("s23", "s24", 1)
net.addLink("s24", "s152")
net.setDelay("s24", "s152", 45)
net.setBw("s24", "s152", 1)
net.addLink("s24", "s152")
net.setDelay("s24", "s152", 44)
net.setBw("s24", "s152", 1)
net.addLink("s25", "s82")
net.setDelay("s25", "s82", 35)
net.setBw("s25", "s82", 1)
net.addLink("s26", "s82")
net.setDelay("s26", "s82", 48)
net.setBw("s26", "s82", 1)
net.addLink("s27", "s82")
net.setDelay("s27", "s82", 62)
net.setBw("s27", "s82", 1)
net.addLink("s28", "s82")
net.setDelay("s28", "s82", 59)
net.setBw("s28", "s82", 1)
net.addLink("s29", "s141")
net.setDelay("s29", "s141", 70)
net.setBw("s29", "s141", 1)
net.addLink("s29", "s30")
net.setDelay("s29", "s30", 40)
net.setBw("s29", "s30", 1)
net.addLink("s31", "s119")
net.setDelay("s31", "s119", 58)
net.setBw("s31", "s119", 1)
net.addLink("s31", "s120")
net.setDelay("s31", "s120", 46)
net.setBw("s31", "s120", 1)
net.addLink("s32", "s120")
net.setDelay("s32", "s120", 58)
net.setBw("s32", "s120", 1)
net.addLink("s32", "s120")
net.setDelay("s32", "s120", 27)
net.setBw("s32", "s120", 1)
net.addLink("s33", "s34")
net.setDelay("s33", "s34", 37)
net.setBw("s33", "s34", 1)
net.addLink("s33", "s36")
net.setDelay("s33", "s36", 74)
net.setBw("s33", "s36", 1)
net.addLink("s34", "s75")
net.setDelay("s34", "s75", 59)
net.setBw("s34", "s75", 1)
net.addLink("s34", "s39")
net.setDelay("s34", "s39", 65)
net.setBw("s34", "s39", 1)
net.addLink("s35", "s120")
net.setDelay("s35", "s120", 27)
net.setBw("s35", "s120", 1)
net.addLink("s35", "s120")
net.setDelay("s35", "s120", 37)
net.setBw("s35", "s120", 1)
net.addLink("s36", "s75")
net.setDelay("s36", "s75", 40)
net.setBw("s36", "s75", 1)
net.addLink("s37", "s74")
net.setDelay("s37", "s74", 36)
net.setBw("s37", "s74", 1)
net.addLink("s37", "s40")
net.setDelay("s37", "s40", 44)
net.setBw("s37", "s40", 1)
net.addLink("s38", "s74")
net.setDelay("s38", "s74", 71)
net.setBw("s38", "s74", 1)
net.addLink("s39", "s75")
net.setDelay("s39", "s75", 44)
net.setBw("s39", "s75", 1)
net.addLink("s40", "s125")
net.setDelay("s40", "s125", 25)
net.setBw("s40", "s125", 1)
net.addLink("s41", "s143")
net.setDelay("s41", "s143", 65)
net.setBw("s41", "s143", 1)
net.addLink("s42", "s143")
net.setDelay("s42", "s143", 27)
net.setBw("s42", "s143", 1)
net.addLink("s43", "s143")
net.setDelay("s43", "s143", 44)
net.setBw("s43", "s143", 1)
net.addLink("s44", "s143")
net.setDelay("s44", "s143", 61)
net.setBw("s44", "s143", 1)
net.addLink("s45", "s143")
net.setDelay("s45", "s143", 47)
net.setBw("s45", "s143", 1)
net.addLink("s46", "s50")
net.setDelay("s46", "s50", 29)
net.setBw("s46", "s50", 1)
net.addLink("s47", "s143")
net.setDelay("s47", "s143", 53)
net.setBw("s47", "s143", 1)
net.addLink("s48", "s143")
net.setDelay("s48", "s143", 27)
net.setBw("s48", "s143", 1)
net.addLink("s49", "s50")
net.setDelay("s49", "s50", 39)
net.setBw("s49", "s50", 1)
net.addLink("s50", "s130")
net.setDelay("s50", "s130", 74)
net.setBw("s50", "s130", 1)
net.addLink("s51", "s57")
net.setDelay("s51", "s57", 32)
net.setBw("s51", "s57", 1)
net.addLink("s51", "s59")
net.setDelay("s51", "s59", 52)
net.setBw("s51", "s59", 1)
net.addLink("s51", "s52")
net.setDelay("s51", "s52", 41)
net.setBw("s51", "s52", 1)
net.addLink("s51", "s53")
net.setDelay("s51", "s53", 51)
net.setBw("s51", "s53", 1)
net.addLink("s51", "s54")
net.setDelay("s51", "s54", 45)
net.setBw("s51", "s54", 1)
net.addLink("s52", "s137")
net.setDelay("s52", "s137", 28)
net.setBw("s52", "s137", 1)
net.addLink("s52", "s54")
net.setDelay("s52", "s54", 58)
net.setBw("s52", "s54", 1)
net.addLink("s52", "s93")
net.setDelay("s52", "s93", 73)
net.setBw("s52", "s93", 1)
net.addLink("s52", "s128")
net.setDelay("s52", "s128", 34)
net.setBw("s52", "s128", 1)
net.addLink("s52", "s128")
net.setDelay("s52", "s128", 44)
net.setBw("s52", "s128", 1)
net.addLink("s54", "s93")
net.setDelay("s54", "s93", 26)
net.setBw("s54", "s93", 1)
net.addLink("s55", "s140")
net.setDelay("s55", "s140", 74)
net.setBw("s55", "s140", 1)
net.addLink("s55", "s141")
net.setDelay("s55", "s141", 48)
net.setBw("s55", "s141", 1)
net.addLink("s55", "s56")
net.setDelay("s55", "s56", 38)
net.setBw("s55", "s56", 1)
net.addLink("s56", "s141")
net.setDelay("s56", "s141", 30)
net.setBw("s56", "s141", 1)
net.addLink("s57", "s58")
net.setDelay("s57", "s58", 25)
net.setBw("s57", "s58", 1)
net.addLink("s57", "s58")
net.setDelay("s57", "s58", 30)
net.setBw("s57", "s58", 1)
net.addLink("s57", "s60")
net.setDelay("s57", "s60", 66)
net.setBw("s57", "s60", 1)
net.addLink("s59", "s60")
net.setDelay("s59", "s60", 39)
net.setBw("s59", "s60", 1)
net.addLink("s61", "s129")
net.setDelay("s61", "s129", 59)
net.setBw("s61", "s129", 1)
net.addLink("s61", "s145")
net.setDelay("s61", "s145", 72)
net.setBw("s61", "s145", 1)
net.addLink("s62", "s82")
net.setDelay("s62", "s82", 48)
net.setBw("s62", "s82", 1)
net.addLink("s63", "s116")
net.setDelay("s63", "s116", 27)
net.setBw("s63", "s116", 1)
net.addLink("s63", "s141")
net.setDelay("s63", "s141", 37)
net.setBw("s63", "s141", 1)
net.addLink("s63", "s95")
net.setDelay("s63", "s95", 44)
net.setBw("s63", "s95", 1)
net.addLink("s64", "s126")
net.setDelay("s64", "s126", 66)
net.setBw("s64", "s126", 1)
net.addLink("s64", "s127")
net.setDelay("s64", "s127", 50)
net.setBw("s64", "s127", 1)
net.addLink("s65", "s73")
net.setDelay("s65", "s73", 43)
net.setBw("s65", "s73", 1)
net.addLink("s65", "s127")
net.setDelay("s65", "s127", 35)
net.setBw("s65", "s127", 1)
net.addLink("s66", "s153")
net.setDelay("s66", "s153", 68)
net.setBw("s66", "s153", 1)
net.addLink("s67", "s153")
net.setDelay("s67", "s153", 51)
net.setBw("s67", "s153", 1)
net.addLink("s67", "s69")
net.setDelay("s67", "s69", 33)
net.setBw("s67", "s69", 1)
net.addLink("s68", "s153")
net.setDelay("s68", "s153", 25)
net.setBw("s68", "s153", 1)
net.addLink("s69", "s82")
net.setDelay("s69", "s82", 29)
net.setBw("s69", "s82", 1)
net.addLink("s69", "s109")
net.setDelay("s69", "s109", 40)
net.setBw("s69", "s109", 1)
net.addLink("s70", "s153")
net.setDelay("s70", "s153", 56)
net.setBw("s70", "s153", 1)
net.addLink("s71", "s153")
net.setDelay("s71", "s153", 71)
net.setBw("s71", "s153", 1)
net.addLink("s72", "s153")
net.setDelay("s72", "s153", 54)
net.setBw("s72", "s153", 1)
net.addLink("s73", "s153")
net.setDelay("s73", "s153", 67)
net.setBw("s73", "s153", 1)
net.addLink("s74", "s121")
net.setDelay("s74", "s121", 40)
net.setBw("s74", "s121", 1)
net.addLink("s74", "s118")
net.setDelay("s74", "s118", 50)
net.setBw("s74", "s118", 1)
net.addLink("s75", "s118")
net.setDelay("s75", "s118", 72)
net.setBw("s75", "s118", 1)
net.addLink("s75", "s126")
net.setDelay("s75", "s126", 73)
net.setBw("s75", "s126", 1)
net.addLink("s76", "s141")
net.setDelay("s76", "s141", 58)
net.setBw("s76", "s141", 1)
net.addLink("s76", "s151")
net.setDelay("s76", "s151", 62)
net.setBw("s76", "s151", 1)
net.addLink("s77", "s141")
net.setDelay("s77", "s141", 53)
net.setBw("s77", "s141", 1)
net.addLink("s77", "s78")
net.setDelay("s77", "s78", 35)
net.setBw("s77", "s78", 1)
net.addLink("s78", "s151")
net.setDelay("s78", "s151", 38)
net.setBw("s78", "s151", 1)
net.addLink("s79", "s116")
net.setDelay("s79", "s116", 58)
net.setBw("s79", "s116", 1)
net.addLink("s79", "s95")
net.setDelay("s79", "s95", 58)
net.setBw("s79", "s95", 1)
net.addLink("s79", "s143")
net.setDelay("s79", "s143", 74)
net.setBw("s79", "s143", 1)
net.addLink("s80", "s138")
net.setDelay("s80", "s138", 53)
net.setBw("s80", "s138", 1)
net.addLink("s80", "s123")
net.setDelay("s80", "s123", 63)
net.setBw("s80", "s123", 1)
net.addLink("s80", "s85")
net.setDelay("s80", "s85", 74)
net.setBw("s80", "s85", 1)
net.addLink("s81", "s138")
net.setDelay("s81", "s138", 57)
net.setBw("s81", "s138", 1)
net.addLink("s81", "s152")
net.setDelay("s81", "s152", 64)
net.setBw("s81", "s152", 1)
net.addLink("s82", "s108")
net.setDelay("s82", "s108", 68)
net.setBw("s82", "s108", 1)
net.addLink("s82", "s94")
net.setDelay("s82", "s94", 48)
net.setBw("s82", "s94", 1)
net.addLink("s83", "s124")
net.setDelay("s83", "s124", 34)
net.setBw("s83", "s124", 1)
net.addLink("s83", "s139")
net.setDelay("s83", "s139", 25)
net.setBw("s83", "s139", 1)
net.addLink("s83", "s84")
...
net.setDelay("s86", "s124", 64)
net.setBw("s86", "s124", 1)
net.addLink("s87", "s122")
net.setDelay("s87", "s122", 47)
net.setBw("s87", "s122", 1)
net.addLink("s87", "s123")
net.setDelay("s87", "s123", 72)
net.setBw("s87", "s123", 1)
net.addLink("s87", "s152")
net.setDelay("s87", "s152", 56)
net.setBw("s87", "s152", 1)
net.addLink("s88", "s153")
net.setDelay("s88", "s153", 56)
net.setBw("s88", "s153", 1)
net.addLink("s89", "s153")
net.setDelay("s89", "s153", 50)
net.setBw("s89", "s153", 1)
net.addLink("s90", "s153")
net.setDelay("s90", "s153", 63)
net.setBw("s90", "s153", 1)
net.addLink("s91", "s139")
net.setDelay("s91", "s139", 75)
net.setBw("s91", "s139", 1)
net.addLink("s92", "s141")
net.setDelay("s92", "s141", 40)
net.setBw("s92", "s141", 1)
net.addLink("s92", "s151")
net.setDelay("s92", "s151", 66)
net.setBw("s92", "s151", 1)
net.addLink("s96", "s108")
net.setDelay("s96", "s108", 75)
net.setBw("s96", "s108", 1)
net.addLink("s97", "s153")
net.setDelay("s97", "s153", 55)
net.setBw("s97", "s153", 1)
net.addLink("s98", "s101")
net.setDelay("s98", "s101", 41)
net.setBw("s98", "s101", 1)
net.addLink("s98", "s101")
net.setDelay("s98", "s101", 56)
net.setBw("s98", "s101", 1)
net.addLink("s99", "s102")
net.setDelay("s99", "s102", 64)
net.setBw("s99", "s102", 1)
net.addLink("s100", "s103")
net.setDelay("s100", "s103", 42)
net.setBw("s100", "s103", 1)
net.addLink("s100", "s103")
net.setDelay("s100", "s103", 39)
net.setBw("s100", "s103", 1)
net.addLink("s102", "s105")
net.setDelay("s102", "s105", 49)
net.setBw("s102", "s105", 1)
net.addLink("s102", "s105")
net.setDelay("s102", "s105", 65)
net.setBw("s102", "s105", 1)
net.addLink("s104", "s153")
net.setDelay("s104", "s153", 28)
net.setBw("s104", "s153", 1)
net.addLink("s106", "s107")
net.setDelay("s106", "s107", 39)
net.setBw("s106", "s107", 1)
net.addLink("s106", "s109")
net.setDelay("s106", "s109", 50)
net.setBw("s106", "s109", 1)
net.addLink("s107", "s153")
net.setDelay("s107", "s153", 43)
net.setBw("s107", "s153", 1)
net.addLink("s108", "s112")
net.setDelay("s108", "s112", 62)
net.setBw("s108", "s112", 1)
net.addLink("s110", "s113")
net.setDelay("s110", "s113", 25)
net.setBw("s110", "s113", 1)
net.addLink("s110", "s153")
net.setDelay("s110", "s153", 62)
net.setBw("s110", "s153", 1)
net.addLink("s111", "s153")
net.setDelay("s111", "s153", 44)
net.setBw("s111", "s153", 1)
net.addLink("s112", "s113")
net.setDelay("s112", "s113", 38)
net.setBw("s112", "s113", 1)
net.addLink("s114", "s153")
net.setDelay("s114", "s153", 49)
net.setBw("s114", "s153", 1)
net.addLink("s115", "s153")
net.setDelay("s115", "s153", 67)
net.setBw("s115", "s153", 1)
net.addLink("s116", "s140")
net.setDelay("s116", "s140", 54)
net.setBw("s116", "s140", 1)
net.addLink("s117", "s143")
net.setDelay("s117", "s143", 58)
net.setBw("s117", "s143", 1)
net.addLink("s118", "s119")
net.setDelay("s118", "s119", 36)
net.setBw("s118", "s119", 1)
net.addLink("s119", "s140")
net.setDelay("s119", "s140", 70)
net.setBw("s119", "s140", 1)
net.addLink("s122", "s149")
net.setDelay("s122", "s149", 53)
net.setBw("s122", "s149", 1)
net.addLink("s124", "s146")
net.setDelay("s124", "s146", 34)
net.setBw("s124", "s146", 1)
net.addLink("s124", "s140")
net.setDelay("s124", "s140", 35)
net.setBw("s124", "s140", 1)
net.addLink("s124", "s125")
net.setDelay("s124", "s125", 43)
net.setBw("s124", "s125", 1)
net.addLink("s130", "s132")
net.setDelay("s130", "s132", 70)
net.setBw("s130", "s132", 1)
net.addLink("s131", "s144")
net.setDelay("s131", "s144", 29)
net.setBw("s131", "s144", 1)
net.addLink("s132", "s144")
net.setDelay("s132", "s144", 32)
net.setBw("s132", "s144", 1)
net.addLink("s133", "s144")
net.setDelay("s133", "s144", 61)
net.setBw("s133", "s144", 1)
net.addLink("s135", "s136")
net.setDelay("s135", "s136", 37)
net.setBw("s135", "s136", 1)
net.addLink("s136", "s137")
net.setDelay("s136", "s137", 36)
net.setBw("s136", "s137", 1)
net.addLink("s139", "s153")
net.setDelay("s139", "s153", 71)
net.setBw("s139", "s153", 1)
net.addLink("s140", "s147")
net.setDelay("s140", "s147", 49)
net.setBw("s140", "s147", 1)
net.addLink("s140", "s150")
net.setDelay("s140", "s150", 70)
net.setBw("s140", "s150", 1)
net.addLink("s141", "s143")
net.setDelay("s141", "s143", 48)
net.setBw("s141", "s143", 1)
net.addLink("s147", "s148")
net.setDelay("s147", "s148", 65)
net.setBw("s147", "s148", 1)
net.addLink("s149", "s150")
net.setDelay("s149", "s150", 37)
net.setBw("s149", "s150", 1)
# Assignment strategy
net.mixed()
