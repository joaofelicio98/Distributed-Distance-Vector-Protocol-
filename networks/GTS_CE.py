...
net.addLink("s1", "s15")
net.setDelay("s1", "s15", 28)
net.setBw("s1", "s15", 1)
net.addLink("s2", "s18")
net.setDelay("s2", "s18", 48)
net.setBw("s2", "s18", 1)
net.addLink("s3", "s129")
net.setDelay("s3", "s129", 67)
net.setBw("s3", "s129", 1)
net.addLink("s3", "s4")
net.setDelay("s3", "s4", 61)
net.setBw("s3", "s4", 1)
net.addLink("s4", "s126")
net.setDelay("s4", "s126", 54)
net.setBw("s4", "s126", 1)
net.addLink("s5", "s17")
net.setDelay("s5", "s17", 63)
net.setBw("s5", "s17", 1)
net.addLink("s5", "s6")
net.setDelay("s5", "s6", 69)
net.setBw("s5", "s6", 1)
net.addLink("s6", "s7")
net.setDelay("s6", "s7", 32)
net.setBw("s6", "s7", 1)
net.addLink("s7", "s8")
net.setDelay("s7", "s8", 34)
net.setBw("s7", "s8", 1)
net.addLink("s8", "s9")
net.setDelay("s8", "s9", 50)
net.setBw("s8", "s9", 1)
net.addLink("s9", "s10")
net.setDelay("s9", "s10", 58)
net.setBw("s9", "s10", 1)
net.addLink("s10", "s15")
net.setDelay("s10", "s15", 66)
net.setBw("s10", "s15", 1)
net.addLink("s11", "s17")
net.setDelay("s11", "s17", 48)
net.setBw("s11", "s17", 1)
net.addLink("s11", "s47")
net.setDelay("s11", "s47", 34)
net.setBw("s11", "s47", 1)
net.addLink("s12", "s99")
net.setDelay("s12", "s99", 60)
net.setBw("s12", "s99", 1)
net.addLink("s12", "s101")
net.setDelay("s12", "s101", 71)
net.setBw("s12", "s101", 1)
net.addLink("s12", "s96")
net.setDelay("s12", "s96", 27)
net.setBw("s12", "s96", 1)
net.addLink("s13", "s118")
net.setDelay("s13", "s118", 41)
net.setBw("s13", "s118", 1)
net.addLink("s14", "s148")
net.setDelay("s14", "s148", 55)
net.setBw("s14", "s148", 1)
net.addLink("s15", "s95")
net.setDelay("s15", "s95", 57)
net.setBw("s15", "s95", 1)
net.addLink("s16", "s132")
net.setDelay("s16", "s132", 50)
net.setBw("s16", "s132", 1)
net.addLink("s16", "s126")
net.setDelay("s16", "s126", 69)
net.setBw("s16", "s126", 1)
net.addLink("s17", "s96")
net.setDelay("s17", "s96", 54)
net.setBw("s17", "s96", 1)
net.addLink("s18", "s133")
net.setDelay("s18", "s133", 67)
net.setBw("s18", "s133", 1)
net.addLink("s18", "s95")
net.setDelay("s18", "s95", 44)
net.setBw("s18", "s95", 1)
net.addLink("s19", "s42")
net.setDelay("s19", "s42", 62)
net.setBw("s19", "s42", 1)
net.addLink("s19", "s104")
net.setDelay("s19", "s104", 64)
net.setBw("s19", "s104", 1)
net.addLink("s20", "s60")
net.setDelay("s20", "s60", 40)
net.setBw("s20", "s60", 1)
net.addLink("s20", "s143")
net.setDelay("s20", "s143", 30)
net.setBw("s20", "s143", 1)
net.addLink("s21", "s81")
net.setDelay("s21", "s81", 72)
net.setBw("s21", "s81", 1)
net.addLink("s21", "s134")
net.setDelay("s21", "s134", 28)
net.setBw("s21", "s134", 1)
net.addLink("s21", "s135")
net.setDelay("s21", "s135", 69)
net.setBw("s21", "s135", 1)
net.addLink("s21", "s142")
net.setDelay("s21", "s142", 26)
net.setBw("s21", "s142", 1)
net.addLink("s21", "s145")
net.setDelay("s21", "s145", 55)
net.setBw("s21", "s145", 1)
net.addLink("s21", "s82")
net.setDelay("s21", "s82", 52)
net.setBw("s21", "s82", 1)
net.addLink("s22", "s27")
net.setDelay("s22", "s27", 55)
net.setBw("s22", "s27", 1)
net.addLink("s22", "s24")
net.setDelay("s22", "s24", 28)
net.setBw("s22", "s24", 1)
net.addLink("s23", "s143")
net.setDelay("s23", "s143", 40)
net.setBw("s23", "s143", 1)
net.addLink("s23", "s24")
net.setDelay("s23", "s24", 44)
net.setBw("s23", "s24", 1)
net.addLink("s25", "s82")
net.setDelay("s25", "s82", 67)
net.setBw("s25", "s82", 1)
net.addLink("s25", "s28")
net.setDelay("s25", "s28", 36)
net.setBw("s25", "s28", 1)
net.addLink("s25", "s26")
net.setDelay("s25", "s26", 25)
net.setBw("s25", "s26", 1)
net.addLink("s26", "s90")
net.setDelay("s26", "s90", 69)
net.setBw("s26", "s90", 1)
net.addLink("s26", "s51")
net.setDelay("s26", "s51", 48)
net.setBw("s26", "s51", 1)
net.addLink("s27", "s28")
net.setDelay("s27", "s28", 46)
net.setBw("s27", "s28", 1)
net.addLink("s28", "s145")
net.setDelay("s28", "s145", 72)
net.setBw("s28", "s145", 1)
net.addLink("s29", "s143")
net.setDelay("s29", "s143", 44)
net.setBw("s29", "s143", 1)
net.addLink("s29", "s55")
net.setDelay("s29", "s55", 75)
net.setBw("s29", "s55", 1)
net.addLink("s30", "s52")
net.setDelay("s30", "s52", 51)
net.setBw("s30", "s52", 1)
net.addLink("s30", "s140")
net.setDelay("s30", "s140", 35)
net.setBw("s30", "s140", 1)
net.addLink("s30", "s143")
net.setDelay("s30", "s143", 35)
net.setBw("s30", "s143", 1)
net.addLink("s31", "s127")
net.setDelay("s31", "s127", 67)
net.setBw("s31", "s127", 1)
net.addLink("s32", "s73")
net.setDelay("s32", "s73", 63)
net.setBw("s32", "s73", 1)
net.addLink("s32", "s63")
net.setDelay("s32", "s63", 72)
net.setBw("s32", "s63", 1)
net.addLink("s33", "s130")
net.setDelay("s33", "s130", 55)
net.setBw("s33", "s130", 1)
net.addLink("s33", "s36")
net.setDelay("s33", "s36", 69)
net.setBw("s33", "s36", 1)
net.addLink("s34", "s130")
net.setDelay("s34", "s130", 39)
net.setBw("s34", "s130", 1)
net.addLink("s34", "s62")
net.setDelay("s34", "s62", 61)
net.setBw("s34", "s62", 1)
net.addLink("s35", "s73")
net.setDelay("s35", "s73", 43)
net.setBw("s35", "s73", 1)
net.addLink("s35", "s74")
net.setDelay("s35", "s74", 61)
net.setBw("s35", "s74", 1)
net.addLink("s36", "s74")
net.setDelay("s36", "s74", 72)
net.setBw("s36", "s74", 1)
net.addLink("s37", "s76")
...
net.setBw("s38", "s123", 1)
net.addLink("s38", "s76")
net.setDelay("s38", "s76", 41)
net.setBw("s38", "s76", 1)
net.addLink("s39", "s77")
net.setDelay("s39", "s77", 43)
net.setBw("s39", "s77", 1)
net.addLink("s39", "s78")
net.setDelay("s39", "s78", 71)
net.setBw("s39", "s78", 1)
net.addLink("s40", "s71")
net.setDelay("s40", "s71", 61)
net.setBw("s40", "s71", 1)
net.addLink("s41", "s65")
net.setDelay("s41", "s65", 71)
net.setBw("s41", "s65", 1)
net.addLink("s41", "s66")
net.setDelay("s41", "s66", 26)
net.setBw("s41", "s66", 1)
net.addLink("s41", "s67")
net.setDelay("s41", "s67", 27)
net.setBw("s41", "s67", 1)
net.addLink("s41", "s64")
net.setDelay("s41", "s64", 38)
net.setBw("s41", "s64", 1)
net.addLink("s42", "s99")
net.setDelay("s42", "s99", 26)
net.setBw("s42", "s99", 1)
net.addLink("s42", "s102")
net.setDelay("s42", "s102", 46)
net.setBw("s42", "s102", 1)
net.addLink("s42", "s105")
net.setDelay("s42", "s105", 62)
net.setBw("s42", "s105", 1)
net.addLink("s42", "s106")
net.setDelay("s42", "s106", 44)
net.setBw("s42", "s106", 1)
net.addLink("s42", "s107")
net.setDelay("s42", "s107", 28)
net.setBw("s42", "s107", 1)
net.addLink("s42", "s45")
net.setDelay("s42", "s45", 71)
net.setBw("s42", "s45", 1)
net.addLink("s42", "s48")
net.setDelay("s42", "s48", 41)
net.setBw("s42", "s48", 1)
net.addLink("s43", "s44")
net.setDelay("s43", "s44", 56)
net.setBw("s43", "s44", 1)
net.addLink("s43", "s149")
net.setDelay("s43", "s149", 56)
net.setBw("s43", "s149", 1)
net.addLink("s44", "s138")
net.setDelay("s44", "s138", 64)
net.setBw("s44", "s138", 1)
net.addLink("s45", "s49")
net.setDelay("s45", "s49", 39)
net.setBw("s45", "s49", 1)
net.addLink("s45", "s46")
net.setDelay("s45", "s46", 47)
net.setBw("s45", "s46", 1)
net.addLink("s46", "s49")
net.setDelay("s46", "s49", 54)
net.setBw("s46", "s49", 1)
net.addLink("s46", "s129")
net.setDelay("s46", "s129", 61)
net.setBw("s46", "s129", 1)
net.addLink("s50", "s129")
net.setDelay("s50", "s129", 43)
net.setBw("s50", "s129", 1)
net.addLink("s50", "s128")
net.setDelay("s50", "s128", 69)
net.setBw("s50", "s128", 1)
net.addLink("s51", "s58")
net.setDelay("s51", "s58", 74)
net.setBw("s51", "s58", 1)
net.addLink("s52", "s118")
net.setDelay("s52", "s118", 67)
net.setBw("s52", "s118", 1)
net.addLink("s52", "s141")
net.setDelay("s52", "s141", 75)
net.setBw("s52", "s141", 1)
net.addLink("s52", "s88")
net.setDelay("s52", "s88", 63)
net.setBw("s52", "s88", 1)
net.addLink("s53", "s144")
net.setDelay("s53", "s144", 41)
net.setBw("s53", "s144", 1)
net.addLink("s53", "s54")
net.setDelay("s53", "s54", 58)
net.setBw("s53", "s54", 1)
net.addLink("s53", "s56")
net.setDelay("s53", "s56", 57)
net.setBw("s53", "s56", 1)
net.addLink("s54", "s59")
net.setDelay("s54", "s59", 47)
net.setBw("s54", "s59", 1)
net.addLink("s55", "s56")
net.setDelay("s55", "s56", 69)
net.setBw("s55", "s56", 1)
net.addLink("s57", "s58")
net.setDelay("s57", "s58", 74)
net.setBw("s57", "s58", 1)
net.addLink("s57", "s60")
net.setDelay("s57", "s60", 65)
net.setBw("s57", "s60", 1)
net.addLink("s59", "s143")
net.setDelay("s59", "s143", 58)
net.setBw("s59", "s143", 1)
net.addLink("s59", "s118")
net.setDelay("s59", "s118", 59)
net.setBw("s59", "s118", 1)
net.addLink("s61", "s131")
net.setDelay("s61", "s131", 54)
net.setBw("s61", "s131", 1)
net.addLink("s62", "s131")
net.setDelay("s62", "s131", 37)
net.setBw("s62", "s131", 1)
net.addLink("s62", "s63")
net.setDelay("s62", "s63", 31)
net.setBw("s62", "s63", 1)
net.addLink("s63", "s132")
net.setDelay("s63", "s132", 53)
net.setBw("s63", "s132", 1)
net.addLink("s65", "s66")
net.setDelay("s65", "s66", 67)
net.setBw("s65", "s66", 1)
net.addLink("s65", "s127")
net.setDelay("s65", "s127", 62)
net.setBw("s65", "s127", 1)
net.addLink("s67", "s103")
net.setDelay("s67", "s103", 48)
net.setBw("s67", "s103", 1)
net.addLink("s68", "s108")
net.setDelay("s68", "s108", 54)
net.setBw("s68", "s108", 1)
net.addLink("s68", "s103")
net.setDelay("s68", "s103", 55)
net.setBw("s68", "s103", 1)
net.addLink("s69", "s131")
net.setDelay("s69", "s131", 30)
net.setBw("s69", "s131", 1)
net.addLink("s69", "s84")
net.setDelay("s69", "s84", 43)
net.setBw("s69", "s84", 1)
net.addLink("s70", "s131")
net.setDelay("s70", "s131", 72)
net.setBw("s70", "s131", 1)
net.addLink("s71", "s121")
net.setDelay("s71", "s121", 64)
net.setBw("s71", "s121", 1)
net.addLink("s71", "s126")
net.setDelay("s71", "s126", 38)
net.setBw("s71", "s126", 1)
net.addLink("s71", "s119")
net.setDelay("s71", "s119", 52)
net.setBw("s71", "s119", 1)
net.addLink("s71", "s78")
net.setDelay("s71", "s78", 32)
net.setBw("s71", "s78", 1)
net.addLink("s72", "s89")
net.setDelay("s72", "s89", 35)
net.setBw("s72", "s89", 1)
net.addLink("s72", "s130")
net.setDelay("s72", "s130", 62)
net.setBw("s72", "s130", 1)
net.addLink("s73", "s124")
net.setDelay("s73", "s124", 33)
net.setBw("s73", "s124", 1)
net.addLink("s75", "s113")
net.setDelay("s75", "s113", 75)
net.setBw("s75", "s113", 1)
net.addLink("s75", "s146")
net.setDelay("s75", "s146", 47)
net.setBw("s75", "s146", 1)
net.addLink("s77", "s123")
net.setDelay("s77", "s123", 39)
net.setBw("s77", "s123", 1)
net.addLink("s78", "s117")
net.setDelay("s78", "s117", 64)
net.setBw("s78", "s117", 1)
net.addLink("s79", "s130")
net.setDelay("s79", "s130", 46)
net.setBw("s79", "s130", 1)
net.addLink("s79", "s86")
net.setDelay("s79", "s86", 63)
net.setBw("s79", "s86", 1)
net.addLink("s80", "s81")
net.setDelay("s80", "s81", 41)
net.setBw("s80", "s81", 1)
net.addLink("s80", "s82")
net.setDelay("s80", "s82", 73)
net.setBw("s80", "s82", 1)
net.addLink("s80", "s87")
...
net.setBw("s82", "s83", 1)
net.addLink("s83", "s86")
net.setDelay("s83", "s86", 41)
net.setBw("s83", "s86", 1)
net.addLink("s84", "s131")
net.setDelay("s84", "s131", 39)
net.setBw("s84", "s131", 1)
net.addLink("s84", "s85")
net.setDelay("s84", "s85", 31)
net.setBw("s84", "s85", 1)
net.addLink("s85", "s131")
net.setDelay("s85", "s131", 32)
net.setBw("s85", "s131", 1)
net.addLink("s87", "s130")
net.setDelay("s87", "s130", 47)
net.setBw("s87", "s130", 1)
net.addLink("s88", "s113")
net.setDelay("s88", "s113", 26)
net.setBw("s88", "s113", 1)
net.addLink("s88", "s146")
net.setDelay("s88", "s146", 60)
net.setBw("s88", "s146", 1)
net.addLink("s88", "s118")
net.setDelay("s88", "s118", 52)
net.setBw("s88", "s118", 1)
net.addLink("s89", "s90")
net.setDelay("s89", "s90", 48)
net.setBw("s89", "s90", 1)
net.addLink("s91", "s141")
net.setDelay("s91", "s141", 54)
net.setBw("s91", "s141", 1)
net.addLink("s91", "s112")
net.setDelay("s91", "s112", 59)
net.setBw("s91", "s112", 1)
net.addLink("s92", "s93")
net.setDelay("s92", "s93", 44)
net.setBw("s92", "s93", 1)
net.addLink("s92", "s110")
net.setDelay("s92", "s110", 44)
net.setBw("s92", "s110", 1)
net.addLink("s93", "s95")
net.setDelay("s93", "s95", 25)
net.setBw("s93", "s95", 1)
net.addLink("s94", "s97")
net.setDelay("s94", "s97", 62)
net.setBw("s94", "s97", 1)
net.addLink("s94", "s101")
net.setDelay("s94", "s101", 59)
net.setBw("s94", "s101", 1)
net.addLink("s94", "s95")
net.setDelay("s94", "s95", 54)
net.setBw("s94", "s95", 1)
net.addLink("s95", "s100")
net.setDelay("s95", "s100", 48)
net.setBw("s95", "s100", 1)
net.addLink("s96", "s97")
net.setDelay("s96", "s97", 31)
net.setBw("s96", "s97", 1)
net.addLink("s98", "s101")
net.setDelay("s98", "s101", 72)
net.setBw("s98", "s101", 1)
net.addLink("s98", "s104")
net.setDelay("s98", "s104", 43)
net.setBw("s98", "s104", 1)
net.addLink("s100", "s104")
net.setDelay("s100", "s104", 51)
net.setBw("s100", "s104", 1)
net.addLink("s102", "s103")
net.setDelay("s102", "s103", 36)
net.setBw("s102", "s103", 1)
net.addLink("s104", "s107")
net.setDelay("s104", "s107", 42)
net.setBw("s104", "s107", 1)
net.addLink("s106", "s109")
net.setDelay("s106", "s109", 59)
net.setBw("s106", "s109", 1)
net.addLink("s108", "s109")
net.setDelay("s108", "s109", 45)
net.setBw("s108", "s109", 1)
net.addLink("s108", "s111")
net.setDelay("s108", "s111", 38)
net.setBw("s108", "s111", 1)
net.addLink("s110", "s111")
net.setDelay("s110", "s111", 36)
net.setBw("s110", "s111", 1)
net.addLink("s111", "s122")
net.setDelay("s111", "s122", 36)
net.setBw("s111", "s122", 1)
net.addLink("s112", "s113")
net.setDelay("s112", "s113", 36)
net.setBw("s112", "s113", 1)
net.addLink("s113", "s146")
net.setDelay("s113", "s146", 75)
net.setBw("s113", "s146", 1)
net.addLink("s113", "s136")
net.setDelay("s113", "s136", 66)
net.setBw("s113", "s136", 1)
net.addLink("s114", "s121")
net.setDelay("s114", "s121", 62)
net.setBw("s114", "s121", 1)
net.addLink("s114", "s117")
net.setDelay("s114", "s117", 25)
net.setBw("s114", "s117", 1)
net.addLink("s115", "s121")
net.setDelay("s115", "s121", 70)
net.setBw("s115", "s121", 1)
net.addLink("s115", "s131")
net.setDelay("s115", "s131", 62)
net.setBw("s115", "s131", 1)
net.addLink("s115", "s116")
net.setDelay("s115", "s116", 35)
net.setBw("s115", "s116", 1)
net.addLink("s116", "s117")
net.setDelay("s116", "s117", 29)
net.setBw("s116", "s117", 1)
net.addLink("s117", "s122")
net.setDelay("s117", "s122", 60)
net.setBw("s117", "s122", 1)
net.addLink("s119", "s120")
net.setDelay("s119", "s120", 62)
net.setBw("s119", "s120", 1)
net.addLink("s120", "s121")
net.setDelay("s120", "s121", 35)
net.setBw("s120", "s121", 1)
net.addLink("s121", "s131")
net.setDelay("s121", "s131", 63)
net.setBw("s121", "s131", 1)
net.addLink("s124", "s132")
net.setDelay("s124", "s132", 68)
net.setBw("s124", "s132", 1)
net.addLink("s124", "s125")
net.setDelay("s124", "s125", 43)
net.setBw("s124", "s125", 1)
net.addLink("s125", "s132")
net.setDelay("s125", "s132", 73)
net.setBw("s125", "s132", 1)
net.addLink("s125", "s142")
net.setDelay("s125", "s142", 60)
net.setBw("s125", "s142", 1)
net.addLink("s126", "s133")
net.setDelay("s126", "s133", 71)
net.setBw("s126", "s133", 1)
net.addLink("s126", "s132")
net.setDelay("s126", "s132", 74)
net.setBw("s126", "s132", 1)
net.addLink("s127", "s128")
net.setDelay("s127", "s128", 33)
net.setBw("s127", "s128", 1)
net.addLink("s131", "s132")
net.setDelay("s131", "s132", 53)
net.setBw("s131", "s132", 1)
net.addLink("s134", "s149")
net.setDelay("s134", "s149", 54)
net.setBw("s134", "s149", 1)
net.addLink("s134", "s142")
net.setDelay("s134", "s142", 56)
net.setBw("s134", "s142", 1)
net.addLink("s135", "s142")
net.setDelay("s135", "s142", 69)
net.setBw("s135", "s142", 1)
net.addLink("s136", "s137")
net.setDelay("s136", "s137", 30)
net.setBw("s136", "s137", 1)
net.addLink("s136", "s147")
net.setDelay("s136", "s147", 64)
net.setBw("s136", "s147", 1)
net.addLink("s137", "s148")
net.setDelay("s137", "s148", 33)
net.setBw("s137", "s148", 1)
net.addLink("s138", "s139")
net.setDelay("s138", "s139", 43)
net.setBw("s138", "s139", 1)
net.addLink("s139", "s141")
net.setDelay("s139", "s141", 30)
net.setBw("s139", "s141", 1)
net.addLink("s140", "s145")
net.setDelay("s140", "s145", 52)
net.setBw("s140", "s145", 1)
net.addLink("s141", "s145")
net.setDelay("s141", "s145", 70)
net.setBw("s141", "s145", 1)
net.addLink("s145", "s149")
net.setDelay("s145", "s149", 68)
net.setBw("s145", "s149", 1)
net.addLink("s146", "s147")
net.setDelay("s146", "s147", 62)
net.setBw("s146", "s147", 1)
net.addLink("s147", "s148")
net.setDelay("s147", "s148", 70)
