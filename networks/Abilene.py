...
net.addLink("s0", "s1")
net.setDelay("s0", "s1", 40)
net.setBw("s0", "s1", 0.001)
net.addLink("s0", "s2")
net.setDelay("s0", "s2", 42)
net.setBw("s0", "s2", 0.001)
net.addLink("s1", "s10")
net.setDelay("s1", "s10", 53)
net.setBw("s1", "s10", 0.001)
net.addLink("s2", "s9")
net.setDelay("s2", "s9", 74)
net.setBw("s2", "s9", 0.001)
net.addLink("s3", "s4")
net.setDelay("s3", "s4", 41)
net.setBw("s3", "s4", 0.001)
net.addLink("s3", "s6")
net.setDelay("s3", "s6", 40)
net.setBw("s3", "s6", 0.001)
net.addLink("s4", "s5")
net.setDelay("s4", "s5", 74)
net.setBw("s4", "s5", 0.001)
net.addLink("s4", "s6")
net.setDelay("s4", "s6", 25)
net.setBw("s4", "s6", 0.001)
net.addLink("s5", "s8")
net.setDelay("s5", "s8", 55)
net.setBw("s5", "s8", 0.001)
net.addLink("s6", "s7")
...
net.addLink("s7", "s10")
net.setDelay("s7", "s10", 33)
net.setBw("s7", "s10", 0.001)
net.addLink("s8", "s9")
net.setDelay("s8", "s9", 53)
net.setBw("s8", "s9", 0.001)
net.addLink("s9", "s10")
net.setDelay("s9", "s10", 33)
