...
net.addLink("s6", "s9")
net.setDelay("s6", "s9", 75)
net.setBw("s6", "s9", 0.001)
net.addLink("s7", "s8")
net.setDelay("s7", "s8", 62)
net.setBw("s7", "s8", 0.001)
net.addLink("s8", "s9")
net.setDelay("s8", "s9", 38)
net.setBw("s8", "s9", 0.001)
net.addLink("s8", "s11")
net.setDelay("s8", "s11", 50)
net.setBw("s8", "s11", 0.001)
net.addLink("s9", "s10")
net.setDelay("s9", "s10", 59)
net.setBw("s9", "s10", 0.001)
net.addLink("s10", "s11")
net.setDelay("s10", "s11", 34)
