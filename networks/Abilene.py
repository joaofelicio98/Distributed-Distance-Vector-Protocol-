...
net.setBw("s1", "s2", 1)
net.addLink("s1", "s3")
net.setDelay("s1", "s3", 28)
net.setBw("s1", "s3", 1)
net.addLink("s2", "s11")
net.setDelay("s2", "s11", 26)
net.setBw("s2", "s11", 1)
net.addLink("s3", "s10")
net.setDelay("s3", "s10", 72)
net.setBw("s3", "s10", 1)
net.addLink("s4", "s5")
net.setDelay("s4", "s5", 54)
net.setBw("s4", "s5", 1)
net.addLink("s4", "s7")
net.setDelay("s4", "s7", 29)
net.setBw("s4", "s7", 1)
net.addLink("s5", "s6")
net.setDelay("s5", "s6", 60)
net.setBw("s5", "s6", 1)
net.addLink("s5", "s7")
net.setDelay("s5", "s7", 31)
net.setBw("s5", "s7", 1)
net.addLink("s6", "s9")
net.setDelay("s6", "s9", 45)
net.setBw("s6", "s9", 1)
net.addLink("s7", "s8")
net.setDelay("s7", "s8", 67)
net.setBw("s7", "s8", 1)
net.addLink("s8", "s9")
net.setDelay("s8", "s9", 38)
net.setBw("s8", "s9", 1)
net.addLink("s8", "s11")
net.setDelay("s8", "s11", 56)
net.setBw("s8", "s11", 1)
net.addLink("s9", "s10")
net.setDelay("s9", "s10", 31)
net.setBw("s9", "s10", 1)
net.addLink("s10", "s11")
net.setDelay("s10", "s11", 29)
net.setBw("s10", "s11", 1)
# Assignment strategy
net.mixed()
