...
net.addLink("s1", "s17")
net.setDelay("s1", "s17", 26)
net.setBw("s1", "s17", 1)
net.addLink("s1", "s4")
net.setDelay("s1", "s4", 47)
net.setBw("s1", "s4", 1)
net.addLink("s1", "s40")
net.setDelay("s1", "s40", 32)
net.setBw("s1", "s40", 1)
net.addLink("s2", "s19")
net.setDelay("s2", "s19", 47)
net.setBw("s2", "s19", 1)
net.addLink("s2", "s40")
net.setDelay("s2", "s40", 31)
net.setBw("s2", "s40", 1)
net.addLink("s3", "s34")
net.setDelay("s3", "s34", 51)
net.setBw("s3", "s34", 1)
net.addLink("s5", "s9")
net.setDelay("s5", "s9", 37)
net.setBw("s5", "s9", 1)
net.addLink("s6", "s39")
net.setDelay("s6", "s39", 72)
net.setBw("s6", "s39", 1)
net.addLink("s7", "s19")
net.setDelay("s7", "s19", 49)
net.setBw("s7", "s19", 1)
net.addLink("s7", "s40")
net.setDelay("s7", "s40", 25)
net.setBw("s7", "s40", 1)
net.addLink("s8", "s40")
net.setDelay("s8", "s40", 59)
net.setBw("s8", "s40", 1)
net.addLink("s9", "s39")
net.setDelay("s9", "s39", 52)
net.setBw("s9", "s39", 1)
net.addLink("s9", "s40")
net.setDelay("s9", "s40", 63)
net.setBw("s9", "s40", 1)
net.addLink("s9", "s10")
net.setDelay("s9", "s10", 27)
net.setBw("s9", "s10", 1)
net.addLink("s9", "s12")
net.setDelay("s9", "s12", 73)
net.setBw("s9", "s12", 1)
net.addLink("s9", "s17")
net.setDelay("s9", "s17", 51)
net.setBw("s9", "s17", 1)
net.addLink("s9", "s19")
net.setDelay("s9", "s19", 63)
net.setBw("s9", "s19", 1)
net.addLink("s9", "s24")
net.setDelay("s9", "s24", 73)
net.setBw("s9", "s24", 1)
net.addLink("s9", "s25")
net.setDelay("s9", "s25", 44)
net.setBw("s9", "s25", 1)
net.addLink("s9", "s26")
net.setDelay("s9", "s26", 41)
net.setBw("s9", "s26", 1)
net.addLink("s9", "s27")
net.setDelay("s9", "s27", 65)
net.setBw("s9", "s27", 1)
net.addLink("s9", "s28")
...
net.setBw("s9", "s29", 1)
net.addLink("s9", "s32")
net.setDelay("s9", "s32", 53)
net.setBw("s9", "s32", 1)
net.addLink("s10", "s28")
net.setDelay("s10", "s28", 31)
net.setBw("s10", "s28", 1)
net.addLink("s11", "s40")
net.setDelay("s11", "s40", 25)
net.setBw("s11", "s40", 1)
net.addLink("s13", "s29")
net.setDelay("s13", "s29", 55)
net.setBw("s13", "s29", 1)
net.addLink("s14", "s26")
net.setDelay("s14", "s26", 54)
net.setBw("s14", "s26", 1)
net.addLink("s15", "s17")
net.setDelay("s15", "s17", 37)
net.setBw("s15", "s17", 1)
net.addLink("s15", "s29")
net.setDelay("s15", "s29", 29)
net.setBw("s15", "s29", 1)
net.addLink("s16", "s17")
net.setDelay("s16", "s17", 30)
net.setBw("s16", "s17", 1)
net.addLink("s16", "s29")
net.setDelay("s16", "s29", 46)
net.setBw("s16", "s29", 1)
net.addLink("s17", "s28")
net.setDelay("s17", "s28", 47)
net.setBw("s17", "s28", 1)
net.addLink("s17", "s29")
net.setDelay("s17", "s29", 38)
net.setBw("s17", "s29", 1)
net.addLink("s18", "s29")
net.setDelay("s18", "s29", 75)
net.setBw("s18", "s29", 1)
net.addLink("s19", "s33")
net.setDelay("s19", "s33", 49)
net.setBw("s19", "s33", 1)
net.addLink("s19", "s34")
net.setDelay("s19", "s34", 64)
net.setBw("s19", "s34", 1)
net.addLink("s19", "s42")
net.setDelay("s19", "s42", 39)
net.setBw("s19", "s42", 1)
net.addLink("s19", "s40")
net.setDelay("s19", "s40", 34)
net.setBw("s19", "s40", 1)
net.addLink("s19", "s41")
net.setDelay("s19", "s41", 32)
net.setBw("s19", "s41", 1)
net.addLink("s19", "s26")
net.setDelay("s19", "s26", 29)
net.setBw("s19", "s26", 1)
net.addLink("s19", "s28")
net.setDelay("s19", "s28", 54)
net.setBw("s19", "s28", 1)
net.addLink("s19", "s29")
net.setDelay("s19", "s29", 75)
net.setBw("s19", "s29", 1)
net.addLink("s20", "s40")
net.setDelay("s20", "s40", 25)
net.setBw("s20", "s40", 1)
net.addLink("s21", "s24")
net.setDelay("s21", "s24", 44)
net.setBw("s21", "s24", 1)
net.addLink("s22", "s29")
net.setDelay("s22", "s29", 73)
net.setBw("s22", "s29", 1)
net.addLink("s23", "s26")
net.setDelay("s23", "s26", 43)
net.setBw("s23", "s26", 1)
net.addLink("s23", "s29")
net.setDelay("s23", "s29", 67)
net.setBw("s23", "s29", 1)
net.addLink("s24", "s29")
net.setDelay("s24", "s29", 33)
net.setBw("s24", "s29", 1)
net.addLink("s24", "s40")
net.setDelay("s24", "s40", 35)
net.setBw("s24", "s40", 1)
net.addLink("s26", "s40")
net.setDelay("s26", "s40", 35)
net.setBw("s26", "s40", 1)
net.addLink("s26", "s28")
net.setDelay("s26", "s28", 71)
net.setBw("s26", "s28", 1)
net.addLink("s28", "s40")
net.setDelay("s28", "s40", 65)
net.setBw("s28", "s40", 1)
net.addLink("s28", "s31")
net.setDelay("s28", "s31", 28)
net.setBw("s28", "s31", 1)
net.addLink("s29", "s39")
net.setDelay("s29", "s39", 56)
net.setBw("s29", "s39", 1)
net.addLink("s29", "s40")
net.setDelay("s29", "s40", 70)
net.setBw("s29", "s40", 1)
net.addLink("s29", "s30")
net.setDelay("s29", "s30", 31)
net.setBw("s29", "s30", 1)
net.addLink("s33", "s40")
net.setDelay("s33", "s40", 34)
net.setBw("s33", "s40", 1)
net.addLink("s34", "s40")
net.setDelay("s34", "s40", 38)
net.setBw("s34", "s40", 1)
net.addLink("s35", "s40")
net.setDelay("s35", "s40", 34)
net.setBw("s35", "s40", 1)
net.addLink("s36", "s40")
net.setDelay("s36", "s40", 65)
net.setBw("s36", "s40", 1)
net.addLink("s37", "s40")
net.setDelay("s37", "s40", 46)
net.setBw("s37", "s40", 1)
net.addLink("s38", "s39")
net.setDelay("s38", "s39", 57)
net.setBw("s38", "s39", 1)
net.addLink("s39", "s40")
net.setDelay("s39", "s40", 66)
net.setBw("s39", "s40", 1)
net.addLink("s40", "s42")
net.setDelay("s40", "s42", 59)
net.setBw("s40", "s42", 1)
net.addLink("s40", "s41")
net.setDelay("s40", "s41", 38)
net.setBw("s40", "s41", 1)
# Assignment strategy
net.mixed()
