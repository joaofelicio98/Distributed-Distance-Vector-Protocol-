...
net.addLink("s1", "s2")
net.setDelay("s1", "s2", 120)
net.setBw("s1", "s2", 1)
net.addLink("s1", "s4")
net.setDelay("s1", "s4", 115)
net.setBw("s1", "s4", 1)
net.addLink("s1", "s37")
net.setDelay("s1", "s37", 122)
net.setBw("s1", "s37", 1)
net.addLink("s1", "s34")
net.setDelay("s1", "s34", 131)
net.setBw("s1", "s34", 1)
net.addLink("s1", "s10")
net.setDelay("s1", "s10", 129)
net.setBw("s1", "s10", 1)
net.addLink("s1", "s36")
net.setDelay("s1", "s36", 129)
net.setBw("s1", "s36", 1)
net.addLink("s2", "s7")
net.setDelay("s2", "s7", 121)
net.setBw("s2", "s7", 1)
net.addLink("s3", "s42")
net.setDelay("s3", "s42", 131)
net.setBw("s3", "s42", 1)
net.addLink("s3", "s43")
net.setDelay("s3", "s43", 118)
net.setBw("s3", "s43", 1)
net.addLink("s3", "s4")
net.setDelay("s3", "s4", 116)
net.setBw("s3", "s4", 1)
net.addLink("s3", "s51")
net.setDelay("s3", "s51", 127)
net.setBw("s3", "s51", 1)
net.addLink("s5", "s6")
net.setDelay("s5", "s6", 116)
net.setBw("s5", "s6", 1)
net.addLink("s5", "s8")
net.setDelay("s5", "s8", 117)
net.setBw("s5", "s8", 1)
net.addLink("s6", "s9")
net.setDelay("s6", "s9", 118)
net.setBw("s6", "s9", 1)
net.addLink("s6", "s7")
net.setDelay("s6", "s7", 113)
net.setBw("s6", "s7", 1)
net.addLink("s7", "s15")
net.setDelay("s7", "s15", 124)
net.setBw("s7", "s15", 1)
net.addLink("s7", "s8")
net.setDelay("s7", "s8", 125)
net.setBw("s7", "s8", 1)
net.addLink("s10", "s18")
net.setDelay("s10", "s18", 115)
net.setBw("s10", "s18", 1)
net.addLink("s11", "s30")
net.setDelay("s11", "s30", 127)
net.setBw("s11", "s30", 1)
net.addLink("s11", "s23")
net.setDelay("s11", "s23", 113)
net.setBw("s11", "s23", 1)
net.addLink("s12", "s13")
net.setDelay("s12", "s13", 120)
net.setBw("s12", "s13", 1)
net.addLink("s12", "s21")
net.setDelay("s12", "s21", 124)
net.setBw("s12", "s21", 1)
net.addLink("s13", "s25")
net.setDelay("s13", "s25", 114)
net.setBw("s13", "s25", 1)
net.addLink("s14", "s17")
net.setDelay("s14", "s17", 126)
net.setBw("s14", "s17", 1)
net.addLink("s14", "s34")
net.setDelay("s14", "s34", 129)
net.setBw("s14", "s34", 1)
net.addLink("s14", "s35")
net.setDelay("s14", "s35", 123)
net.setBw("s14", "s35", 1)
net.addLink("s14", "s27")
net.setDelay("s14", "s27", 112)
net.setBw("s14", "s27", 1)
net.addLink("s15", "s19")
net.setDelay("s15", "s19", 114)
net.setBw("s15", "s19", 1)
net.addLink("s15", "s24")
net.setDelay("s15", "s24", 128)
net.setBw("s15", "s24", 1)
net.addLink("s15", "s16")
net.setDelay("s15", "s16", 112)
net.setBw("s15", "s16", 1)
net.addLink("s16", "s17")
net.setDelay("s16", "s17", 132)
net.setBw("s16", "s17", 1)
net.addLink("s17", "s18")
net.setDelay("s17", "s18", 108)
net.setBw("s17", "s18", 1)
net.addLink("s17", "s37")
net.setDelay("s17", "s37", 119)
net.setBw("s17", "s37", 1)
net.addLink("s19", "s20")
net.setDelay("s19", "s20", 126)
net.setBw("s19", "s20", 1)
net.addLink("s20", "s21")
net.setDelay("s20", "s21", 120)
net.setBw("s20", "s21", 1)
net.addLink("s22", "s23")
net.setDelay("s22", "s23", 114)
net.setBw("s22", "s23", 1)
net.addLink("s24", "s25")
net.setDelay("s24", "s25", 117)
net.setBw("s24", "s25", 1)
net.addLink("s24", "s27")
net.setDelay("s24", "s27", 114)
net.setBw("s24", "s27", 1)
net.addLink("s24", "s29")
net.setDelay("s24", "s29", 115)
net.setBw("s24", "s29", 1)
net.addLink("s24", "s32")
net.setDelay("s24", "s32", 115)
net.setBw("s24", "s32", 1)
net.addLink("s26", "s27")
net.setDelay("s26", "s27", 113)
net.setBw("s26", "s27", 1)
net.addLink("s26", "s29")
net.setDelay("s26", "s29", 115)
net.setBw("s26", "s29", 1)
net.addLink("s28", "s29")
net.setDelay("s28", "s29", 108)
net.setBw("s28", "s29", 1)
net.addLink("s28", "s31")
net.setDelay("s28", "s31", 119)
net.setBw("s28", "s31", 1)
net.addLink("s30", "s33")
net.setDelay("s30", "s33", 116)
net.setBw("s30", "s33", 1)
net.addLink("s30", "s38")
net.setDelay("s30", "s38", 132)
net.setBw("s30", "s38", 1)
net.addLink("s30", "s31")
net.setDelay("s30", "s31", 131)
net.setBw("s30", "s31", 1)
net.addLink("s32", "s34")
net.setDelay("s32", "s34", 118)
net.setBw("s32", "s34", 1)
net.addLink("s33", "s34")
net.setDelay("s33", "s34", 122)
net.setBw("s33", "s34", 1)
net.addLink("s33", "s39")
net.setDelay("s33", "s39", 123)
net.setBw("s33", "s39", 1)
net.addLink("s33", "s48")
net.setDelay("s33", "s48", 125)
net.setBw("s33", "s48", 1)
net.addLink("s35", "s36")
net.setDelay("s35", "s36", 118)
net.setBw("s35", "s36", 1)
net.addLink("s38", "s46")
net.setDelay("s38", "s46", 115)
net.setBw("s38", "s46", 1)
net.addLink("s39", "s40")
net.setDelay("s39", "s40", 118)
net.setBw("s39", "s40", 1)
net.addLink("s40", "s41")
net.setDelay("s40", "s41", 112)
net.setBw("s40", "s41", 1)
net.addLink("s40", "s49")
net.setDelay("s40", "s49", 118)
net.setBw("s40", "s49", 1)
net.addLink("s42", "s51")
net.setDelay("s42", "s51", 128)
net.setBw("s42", "s51", 1)
net.addLink("s44", "s50")
net.setDelay("s44", "s50", 121)
net.setBw("s44", "s50", 1)
net.addLink("s44", "s45")
net.setDelay("s44", "s45", 112)
net.setBw("s44", "s45", 1)
net.addLink("s45", "s46")
net.setDelay("s45", "s46", 116)
net.setBw("s45", "s46", 1)
net.addLink("s46", "s47")
net.setDelay("s46", "s47", 109)
net.setBw("s46", "s47", 1)
net.addLink("s47", "s48")
net.setDelay("s47", "s48", 124)
net.setBw("s47", "s48", 1)
net.addLink("s48", "s49")
net.setDelay("s48", "s49", 109)
net.setBw("s48", "s49", 1)
net.addLink("s49", "s50")
net.setDelay("s49", "s50", 120)
net.setBw("s49", "s50", 1)
# Assignment strategy
net.mixed()
