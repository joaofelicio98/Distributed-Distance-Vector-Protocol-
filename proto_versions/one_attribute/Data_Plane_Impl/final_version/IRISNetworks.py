...
net.addLink("s1", "s2")
net.setDelay("s1", "s2", 46)
net.setBw("s1", "s2", 1)
net.addLink("s1", "s4")
net.setDelay("s1", "s4", 46)
net.setBw("s1", "s4", 1)
net.addLink("s1", "s37")
net.setDelay("s1", "s37", 67)
net.setBw("s1", "s37", 1)
net.addLink("s1", "s34")
net.setDelay("s1", "s34", 36)
net.setBw("s1", "s34", 1)
net.addLink("s1", "s10")
net.setDelay("s1", "s10", 37)
net.setBw("s1", "s10", 1)
net.addLink("s1", "s36")
net.setDelay("s1", "s36", 68)
net.setBw("s1", "s36", 1)
net.addLink("s2", "s7")
net.setDelay("s2", "s7", 36)
net.setBw("s2", "s7", 1)
net.addLink("s3", "s42")
net.setDelay("s3", "s42", 34)
net.setBw("s3", "s42", 1)
net.addLink("s3", "s43")
net.setDelay("s3", "s43", 38)
net.setBw("s3", "s43", 1)
net.addLink("s3", "s4")
net.setDelay("s3", "s4", 69)
net.setBw("s3", "s4", 1)
net.addLink("s3", "s51")
net.setDelay("s3", "s51", 29)
net.setBw("s3", "s51", 1)
net.addLink("s5", "s6")
net.setDelay("s5", "s6", 52)
net.setBw("s5", "s6", 1)
net.addLink("s5", "s8")
net.setDelay("s5", "s8", 41)
net.setBw("s5", "s8", 1)
net.addLink("s6", "s9")
net.setDelay("s6", "s9", 34)
net.setBw("s6", "s9", 1)
net.addLink("s6", "s7")
net.setDelay("s6", "s7", 31)
net.setBw("s6", "s7", 1)
net.addLink("s7", "s15")
net.setDelay("s7", "s15", 34)
net.setBw("s7", "s15", 1)
net.addLink("s7", "s8")
net.setDelay("s7", "s8", 27)
net.setBw("s7", "s8", 1)
net.addLink("s10", "s18")
net.setDelay("s10", "s18", 66)
net.setBw("s10", "s18", 1)
net.addLink("s11", "s30")
net.setDelay("s11", "s30", 56)
net.setBw("s11", "s30", 1)
net.addLink("s11", "s23")
net.setDelay("s11", "s23", 75)
net.setBw("s11", "s23", 1)
net.addLink("s12", "s13")
net.setDelay("s12", "s13", 50)
net.setBw("s12", "s13", 1)
net.addLink("s12", "s21")
net.setDelay("s12", "s21", 69)
net.setBw("s12", "s21", 1)
net.addLink("s13", "s25")
net.setDelay("s13", "s25", 43)
net.setBw("s13", "s25", 1)
net.addLink("s14", "s17")
net.setDelay("s14", "s17", 25)
net.setBw("s14", "s17", 1)
net.addLink("s14", "s34")
net.setDelay("s14", "s34", 33)
net.setBw("s14", "s34", 1)
net.addLink("s14", "s35")
net.setDelay("s14", "s35", 25)
net.setBw("s14", "s35", 1)
net.addLink("s14", "s27")
net.setDelay("s14", "s27", 36)
net.setBw("s14", "s27", 1)
net.addLink("s15", "s19")
net.setDelay("s15", "s19", 25)
net.setBw("s15", "s19", 1)
net.addLink("s15", "s24")
net.setDelay("s15", "s24", 30)
net.setBw("s15", "s24", 1)
net.addLink("s15", "s16")
net.setDelay("s15", "s16", 34)
net.setBw("s15", "s16", 1)
net.addLink("s16", "s17")
net.setDelay("s16", "s17", 75)
net.setBw("s16", "s17", 1)
net.addLink("s17", "s18")
net.setDelay("s17", "s18", 27)
net.setBw("s17", "s18", 1)
net.addLink("s17", "s37")
net.setDelay("s17", "s37", 71)
net.setBw("s17", "s37", 1)
net.addLink("s19", "s20")
net.setDelay("s19", "s20", 67)
net.setBw("s19", "s20", 1)
net.addLink("s20", "s21")
net.setDelay("s20", "s21", 36)
net.setBw("s20", "s21", 1)
net.addLink("s22", "s23")
net.setDelay("s22", "s23", 54)
net.setBw("s22", "s23", 1)
net.addLink("s24", "s25")
net.setDelay("s24", "s25", 28)
net.setBw("s24", "s25", 1)
net.addLink("s24", "s27")
net.setDelay("s24", "s27", 28)
net.setBw("s24", "s27", 1)
net.addLink("s24", "s29")
net.setDelay("s24", "s29", 60)
net.setBw("s24", "s29", 1)
net.addLink("s24", "s32")
net.setDelay("s24", "s32", 67)
net.setBw("s24", "s32", 1)
net.addLink("s26", "s27")
net.setDelay("s26", "s27", 51)
net.setBw("s26", "s27", 1)
net.addLink("s26", "s29")
net.setDelay("s26", "s29", 57)
net.setBw("s26", "s29", 1)
net.addLink("s28", "s29")
net.setDelay("s28", "s29", 52)
net.setBw("s28", "s29", 1)
net.addLink("s28", "s31")
net.setDelay("s28", "s31", 61)
net.setBw("s28", "s31", 1)
net.addLink("s30", "s33")
net.setDelay("s30", "s33", 68)
net.setBw("s30", "s33", 1)
net.addLink("s30", "s38")
net.setDelay("s30", "s38", 62)
net.setBw("s30", "s38", 1)
net.addLink("s30", "s31")
net.setDelay("s30", "s31", 69)
net.setBw("s30", "s31", 1)
net.addLink("s32", "s34")
net.setDelay("s32", "s34", 44)
net.setBw("s32", "s34", 1)
net.addLink("s33", "s34")
net.setDelay("s33", "s34", 51)
net.setBw("s33", "s34", 1)
net.addLink("s33", "s39")
net.setDelay("s33", "s39", 71)
net.setBw("s33", "s39", 1)
net.addLink("s33", "s48")
net.setDelay("s33", "s48", 59)
net.setBw("s33", "s48", 1)
net.addLink("s35", "s36")
net.setDelay("s35", "s36", 49)
net.setBw("s35", "s36", 1)
net.addLink("s38", "s46")
net.setDelay("s38", "s46", 34)
net.setBw("s38", "s46", 1)
net.addLink("s39", "s40")
net.setDelay("s39", "s40", 40)
net.setBw("s39", "s40", 1)
net.addLink("s40", "s41")
net.setDelay("s40", "s41", 54)
net.setBw("s40", "s41", 1)
net.addLink("s40", "s49")
net.setDelay("s40", "s49", 52)
net.setBw("s40", "s49", 1)
net.addLink("s42", "s51")
net.setDelay("s42", "s51", 49)
net.setBw("s42", "s51", 1)
net.addLink("s44", "s50")
net.setDelay("s44", "s50", 73)
net.setBw("s44", "s50", 1)
net.addLink("s44", "s45")
net.setDelay("s44", "s45", 50)
net.setBw("s44", "s45", 1)
net.addLink("s45", "s46")
net.setDelay("s45", "s46", 42)
net.setBw("s45", "s46", 1)
net.addLink("s46", "s47")
net.setDelay("s46", "s47", 62)
net.setBw("s46", "s47", 1)
net.addLink("s47", "s48")
net.setDelay("s47", "s48", 26)
net.setBw("s47", "s48", 1)
net.addLink("s48", "s49")
net.setDelay("s48", "s49", 66)
net.setBw("s48", "s49", 1)
net.addLink("s49", "s50")
net.setDelay("s49", "s50", 71)
net.setBw("s49", "s50", 1)
# Assignment strategy
net.mixed()
