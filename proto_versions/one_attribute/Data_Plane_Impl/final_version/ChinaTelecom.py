...
net.addLink("s1", "s17")
net.setDelay("s1", "s17", 166)
net.setBw("s1", "s17", 1)
net.addLink("s1", "s4")
net.setDelay("s1", "s4", 296)
net.setBw("s1", "s4", 1)
net.addLink("s1", "s40")
net.setDelay("s1", "s40", 26)
net.setBw("s1", "s40", 1)
net.addLink("s2", "s19")
net.setDelay("s2", "s19", 43)
net.setBw("s2", "s19", 1)
net.addLink("s2", "s40")
net.setDelay("s2", "s40", 236)
net.setBw("s2", "s40", 1)
net.addLink("s3", "s34")
net.setDelay("s3", "s34", 226)
net.setBw("s3", "s34", 1)
net.addLink("s5", "s9")
net.setDelay("s5", "s9", 31)
net.setBw("s5", "s9", 1)
net.addLink("s6", "s39")
net.setDelay("s6", "s39", 174)
net.setBw("s6", "s39", 1)
net.addLink("s7", "s19")
net.setDelay("s7", "s19", 131)
net.setBw("s7", "s19", 1)
net.addLink("s7", "s40")
net.setDelay("s7", "s40", 165)
net.setBw("s7", "s40", 1)
net.addLink("s8", "s40")
net.setDelay("s8", "s40", 149)
net.setBw("s8", "s40", 1)
net.addLink("s9", "s39")
net.setDelay("s9", "s39", 75)
net.setBw("s9", "s39", 1)
net.addLink("s9", "s40")
net.setDelay("s9", "s40", 87)
net.setBw("s9", "s40", 1)
net.addLink("s9", "s10")
net.setDelay("s9", "s10", 93)
net.setBw("s9", "s10", 1)
net.addLink("s9", "s12")
net.setDelay("s9", "s12", 216)
net.setBw("s9", "s12", 1)
net.addLink("s9", "s17")
net.setDelay("s9", "s17", 243)
net.setBw("s9", "s17", 1)
net.addLink("s9", "s19")
net.setDelay("s9", "s19", 155)
net.setBw("s9", "s19", 1)
net.addLink("s9", "s24")
net.setDelay("s9", "s24", 61)
net.setBw("s9", "s24", 1)
net.addLink("s9", "s25")
net.setDelay("s9", "s25", 218)
net.setBw("s9", "s25", 1)
net.addLink("s9", "s26")
net.setDelay("s9", "s26", 246)
net.setBw("s9", "s26", 1)
net.addLink("s9", "s27")
net.setDelay("s9", "s27", 160)
net.setBw("s9", "s27", 1)
net.addLink("s9", "s28")
net.setDelay("s9", "s28", 206)
net.setBw("s9", "s28", 1)
net.addLink("s9", "s29")
net.setDelay("s9", "s29", 184)
net.setBw("s9", "s29", 1)
net.addLink("s9", "s32")
net.setDelay("s9", "s32", 282)
net.setBw("s9", "s32", 1)
net.addLink("s10", "s28")
net.setDelay("s10", "s28", 169)
net.setBw("s10", "s28", 1)
net.addLink("s11", "s40")
net.setDelay("s11", "s40", 132)
net.setBw("s11", "s40", 1)
net.addLink("s13", "s29")
net.setDelay("s13", "s29", 103)
net.setBw("s13", "s29", 1)
net.addLink("s14", "s26")
net.setDelay("s14", "s26", 278)
net.setBw("s14", "s26", 1)
net.addLink("s15", "s17")
net.setDelay("s15", "s17", 173)
net.setBw("s15", "s17", 1)
net.addLink("s15", "s29")
net.setDelay("s15", "s29", 206)
net.setBw("s15", "s29", 1)
net.addLink("s16", "s17")
net.setDelay("s16", "s17", 93)
net.setBw("s16", "s17", 1)
net.addLink("s16", "s29")
net.setDelay("s16", "s29", 278)
net.setBw("s16", "s29", 1)
net.addLink("s17", "s28")
net.setDelay("s17", "s28", 281)
net.setBw("s17", "s28", 1)
net.addLink("s17", "s29")
net.setDelay("s17", "s29", 75)
net.setBw("s17", "s29", 1)
net.addLink("s18", "s29")
net.setDelay("s18", "s29", 53)
net.setBw("s18", "s29", 1)
net.addLink("s19", "s33")
net.setDelay("s19", "s33", 93)
net.setBw("s19", "s33", 1)
net.addLink("s19", "s34")
net.setDelay("s19", "s34", 43)
net.setBw("s19", "s34", 1)
net.addLink("s19", "s42")
net.setDelay("s19", "s42", 257)
net.setBw("s19", "s42", 1)
net.addLink("s19", "s40")
net.setDelay("s19", "s40", 48)
net.setBw("s19", "s40", 1)
net.addLink("s19", "s41")
net.setDelay("s19", "s41", 36)
net.setBw("s19", "s41", 1)
net.addLink("s19", "s26")
net.setDelay("s19", "s26", 130)
net.setBw("s19", "s26", 1)
net.addLink("s19", "s28")
net.setDelay("s19", "s28", 285)
net.setBw("s19", "s28", 1)
net.addLink("s19", "s29")
net.setDelay("s19", "s29", 170)
net.setBw("s19", "s29", 1)
net.addLink("s20", "s40")
net.setDelay("s20", "s40", 147)
net.setBw("s20", "s40", 1)
net.addLink("s21", "s24")
net.setDelay("s21", "s24", 129)
net.setBw("s21", "s24", 1)
net.addLink("s22", "s29")
net.setDelay("s22", "s29", 210)
net.setBw("s22", "s29", 1)
net.addLink("s23", "s26")
net.setDelay("s23", "s26", 190)
net.setBw("s23", "s26", 1)
net.addLink("s23", "s29")
net.setDelay("s23", "s29", 231)
net.setBw("s23", "s29", 1)
net.addLink("s24", "s29")
net.setDelay("s24", "s29", 196)
net.setBw("s24", "s29", 1)
net.addLink("s24", "s40")
net.setDelay("s24", "s40", 219)
net.setBw("s24", "s40", 1)
net.addLink("s26", "s40")
net.setDelay("s26", "s40", 285)
net.setBw("s26", "s40", 1)
net.addLink("s26", "s28")
net.setDelay("s26", "s28", 209)
net.setBw("s26", "s28", 1)
net.addLink("s28", "s40")
net.setDelay("s28", "s40", 158)
net.setBw("s28", "s40", 1)
net.addLink("s28", "s31")
net.setDelay("s28", "s31", 74)
net.setBw("s28", "s31", 1)
net.addLink("s29", "s39")
net.setDelay("s29", "s39", 155)
net.setBw("s29", "s39", 1)
net.addLink("s29", "s40")
net.setDelay("s29", "s40", 216)
net.setBw("s29", "s40", 1)
net.addLink("s29", "s30")
net.setDelay("s29", "s30", 48)
net.setBw("s29", "s30", 1)
net.addLink("s33", "s40")
net.setDelay("s33", "s40", 30)
net.setBw("s33", "s40", 1)
net.addLink("s34", "s40")
net.setDelay("s34", "s40", 276)
net.setBw("s34", "s40", 1)
net.addLink("s35", "s40")
net.setDelay("s35", "s40", 266)
net.setBw("s35", "s40", 1)
net.addLink("s36", "s40")
net.setDelay("s36", "s40", 33)
net.setBw("s36", "s40", 1)
net.addLink("s37", "s40")
net.setDelay("s37", "s40", 284)
net.setBw("s37", "s40", 1)
net.addLink("s38", "s39")
net.setDelay("s38", "s39", 174)
net.setBw("s38", "s39", 1)
net.addLink("s39", "s40")
net.setDelay("s39", "s40", 83)
net.setBw("s39", "s40", 1)
net.addLink("s40", "s42")
net.setDelay("s40", "s42", 226)
net.setBw("s40", "s42", 1)
net.addLink("s40", "s41")
net.setDelay("s40", "s41", 277)
net.setBw("s40", "s41", 1)
# Assignment strategy
net.mixed()
