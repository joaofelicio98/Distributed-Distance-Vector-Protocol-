...
net.addLink("s1", "s49")
net.setDelay("s1", "s49", 130)
net.setBw("s1", "s49", 1)
net.addLink("s2", "s5")
net.setDelay("s2", "s5", 127)
net.setBw("s2", "s5", 1)
net.addLink("s3", "s43")
net.setDelay("s3", "s43", 109)
net.setBw("s3", "s43", 1)
net.addLink("s4", "s51")
net.setDelay("s4", "s51", 116)
net.setBw("s4", "s51", 1)
net.addLink("s5", "s36")
net.setDelay("s5", "s36", 117)
net.setBw("s5", "s36", 1)
net.addLink("s5", "s50")
net.setDelay("s5", "s50", 126)
net.setBw("s5", "s50", 1)
net.addLink("s6", "s47")
net.setDelay("s6", "s47", 108)
net.setBw("s6", "s47", 1)
net.addLink("s7", "s27")
net.setDelay("s7", "s27", 124)
net.setBw("s7", "s27", 1)
net.addLink("s7", "s32")
net.setDelay("s7", "s32", 131)
net.setBw("s7", "s32", 1)
net.addLink("s8", "s49")
net.setDelay("s8", "s49", 128)
net.setBw("s8", "s49", 1)
net.addLink("s9", "s47")
net.setDelay("s9", "s47", 114)
net.setBw("s9", "s47", 1)
net.addLink("s10", "s47")
net.setDelay("s10", "s47", 123)
net.setBw("s10", "s47", 1)
net.addLink("s11", "s16")
net.setDelay("s11", "s16", 116)
net.setBw("s11", "s16", 1)
net.addLink("s11", "s36")
net.setDelay("s11", "s36", 132)
net.setBw("s11", "s36", 1)
net.addLink("s11", "s47")
net.setDelay("s11", "s47", 114)
net.setBw("s11", "s47", 1)
net.addLink("s11", "s40")
net.setDelay("s11", "s40", 108)
net.setBw("s11", "s40", 1)
net.addLink("s12", "s36")
net.setDelay("s12", "s36", 129)
net.setBw("s12", "s36", 1)
net.addLink("s12", "s32")
net.setDelay("s12", "s32", 128)
net.setBw("s12", "s32", 1)
net.addLink("s13", "s36")
net.setDelay("s13", "s36", 113)
net.setBw("s13", "s36", 1)
net.addLink("s13", "s32")
net.setDelay("s13", "s32", 117)
net.setBw("s13", "s32", 1)
net.addLink("s14", "s16")
net.setDelay("s14", "s16", 131)
net.setBw("s14", "s16", 1)
net.addLink("s15", "s16")
net.setDelay("s15", "s16", 119)
net.setBw("s15", "s16", 1)
net.addLink("s16", "s17")
net.setDelay("s16", "s17", 110)
net.setBw("s16", "s17", 1)
net.addLink("s18", "s36")
net.setDelay("s18", "s36", 118)
net.setBw("s18", "s36", 1)
net.addLink("s18", "s32")
net.setDelay("s18", "s32", 127)
net.setBw("s18", "s32", 1)
net.addLink("s19", "s32")
net.setDelay("s19", "s32", 126)
net.setBw("s19", "s32", 1)
net.addLink("s20", "s21")
net.setDelay("s20", "s21", 111)
net.setBw("s20", "s21", 1)
net.addLink("s21", "s36")
net.setDelay("s21", "s36", 114)
net.setBw("s21", "s36", 1)
net.addLink("s21", "s22")
net.setDelay("s21", "s22", 115)
net.setBw("s21", "s22", 1)
net.addLink("s21", "s32")
net.setDelay("s21", "s32", 116)
net.setBw("s21", "s32", 1)
net.addLink("s23", "s26")
net.setDelay("s23", "s26", 111)
net.setBw("s23", "s26", 1)
net.addLink("s23", "s32")
net.setDelay("s23", "s32", 112)
net.setBw("s23", "s32", 1)
net.addLink("s24", "s27")
net.setDelay("s24", "s27", 132)
net.setBw("s24", "s27", 1)
net.addLink("s25", "s27")
net.setDelay("s25", "s27", 109)
net.setBw("s25", "s27", 1)
net.addLink("s26", "s36")
net.setDelay("s26", "s36", 122)
net.setBw("s26", "s36", 1)
net.addLink("s26", "s32")
net.setDelay("s26", "s32", 119)
net.setBw("s26", "s32", 1)
net.addLink("s27", "s36")
net.setDelay("s27", "s36", 118)
net.setBw("s27", "s36", 1)
net.addLink("s27", "s48")
net.setDelay("s27", "s48", 122)
net.setBw("s27", "s48", 1)
net.addLink("s28", "s36")
net.setDelay("s28", "s36", 110)
net.setBw("s28", "s36", 1)
net.addLink("s28", "s29")
net.setDelay("s28", "s29", 122)
net.setBw("s28", "s29", 1)
net.addLink("s28", "s30")
net.setDelay("s28", "s30", 132)
net.setBw("s28", "s30", 1)
net.addLink("s28", "s31")
net.setDelay("s28", "s31", 126)
net.setBw("s28", "s31", 1)
net.addLink("s28", "s32")
net.setDelay("s28", "s32", 119)
net.setBw("s28", "s32", 1)
net.addLink("s32", "s33")
net.setDelay("s32", "s33", 114)
net.setBw("s32", "s33", 1)
net.addLink("s32", "s35")
net.setDelay("s32", "s35", 130)
net.setBw("s32", "s35", 1)
net.addLink("s32", "s38")
net.setDelay("s32", "s38", 127)
net.setBw("s32", "s38", 1)
net.addLink("s32", "s40")
net.setDelay("s32", "s40", 119)
net.setBw("s32", "s40", 1)
net.addLink("s32", "s41")
net.setDelay("s32", "s41", 114)
net.setBw("s32", "s41", 1)
net.addLink("s32", "s44")
net.setDelay("s32", "s44", 110)
net.setBw("s32", "s44", 1)
net.addLink("s32", "s36")
net.setDelay("s32", "s36", 113)
net.setBw("s32", "s36", 1)
net.addLink("s32", "s50")
net.setDelay("s32", "s50", 130)
net.setBw("s32", "s50", 1)
net.addLink("s32", "s39")
net.setDelay("s32", "s39", 118)
net.setBw("s32", "s39", 1)
net.addLink("s34", "s41")
net.setDelay("s34", "s41", 124)
net.setBw("s34", "s41", 1)
net.addLink("s35", "s36")
net.setDelay("s35", "s36", 109)
net.setBw("s35", "s36", 1)
net.addLink("s36", "s41")
net.setDelay("s36", "s41", 118)
net.setBw("s36", "s41", 1)
net.addLink("s36", "s44")
net.setDelay("s36", "s44", 110)
net.setBw("s36", "s44", 1)
net.addLink("s36", "s45")
net.setDelay("s36", "s45", 121)
net.setBw("s36", "s45", 1)
net.addLink("s36", "s49")
net.setDelay("s36", "s49", 113)
net.setBw("s36", "s49", 1)
net.addLink("s36", "s50")
net.setDelay("s36", "s50", 123)
net.setBw("s36", "s50", 1)
net.addLink("s37", "s47")
net.setDelay("s37", "s47", 108)
net.setBw("s37", "s47", 1)
net.addLink("s39", "s45")
net.setDelay("s39", "s45", 130)
net.setBw("s39", "s45", 1)
net.addLink("s42", "s51")
net.setDelay("s42", "s51", 114)
net.setBw("s42", "s51", 1)
net.addLink("s43", "s51")
net.setDelay("s43", "s51", 117)
net.setBw("s43", "s51", 1)
net.addLink("s45", "s46")
net.setDelay("s45", "s46", 117)
net.setBw("s45", "s46", 1)
net.addLink("s49", "s50")
net.setDelay("s49", "s50", 114)
net.setBw("s49", "s50", 1)
net.addLink("s50", "s51")
net.setDelay("s50", "s51", 123)
net.setBw("s50", "s51", 1)
# Assignment strategy
net.mixed()
